...
const JobAccordion = ({ data, onClose }) => {
  ...
  const sendFormData = async (values, reset) => {
    ...
    try {
      ...
      toast.error(error?.response?.data?.message || error.message || "Failed to submit the form.");
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className={style.modalBody}>
            ...
            <div className={style.content}>
              ...
              <Formik
                ...
                onSubmit={(values, { resetForm }) => sendFormData(values, resetForm)}
              >
                <Form className={style.contactFormWrap}>
                  ...
                  <div className={style.formGroup}>
                    <button type="submit" className={style.themeBtn} disabled={loading || !hasFile}>
