    ...
    >
      ...
      <div style={{ marginTop: "30px" }}>
        ...
        <MenuItem
          icon={<FaBuilding />}
          text="Properties"
          path="property-listing/search/property-in-india"
          onClick={handleNavigation}
          activeColor={isActive("property-listing/search/property-in-india")}
        />
        <MenuItem
          icon={<GrServices />}
          text="Services"
          path="our-services"
          onClick={handleNavigation}
          activeColor={isActive("our-services")}
        />
        <MenuItem
          ...
          path="calculators"
          onClick={handleNavigation}
          activeColor={isActive("calculators")}
        />
        <MenuItem
          icon={<MdContactMail />}
          text="Contact Us"
          path="contact-us"
          onClick={handleNavigation}
          activeColor={isActive("contact-us")}
        />
      </div>
      ...
      <MenuItem
        ...
        path="testimonials"
        onClick={handleNavigation}
        activeColor={isActive("testimonials")}
      />
      <MenuItem
        icon={<MdOutlinePermMedia />}
        text="Media And Blogs"
        path="blog"
        onClick={handleNavigation}
        activeColor={isActive("blog")}
      />
      ...
      <MenuItem
        ...
        onClick={handleNavigation}
        activeColor={isActive("page/terms-conditions")}
      />
      <MenuItem
        ...
        onClick={handleNavigation}
        activeColor={isActive("page/privacy-policy")}
      />
      <MenuItem
        ...
        onClick={handleNavigation}
        activeColor={isActive("page/disclaimer")}
      />
      <MenuItem
        icon={<PiHandshakeThin />}
        text="User Agreement"
        path="page/user-agreement"
        onClick={handleNavigation}
        activeColor={isActive("page/user-agreement")}
      />
      ...
      <div style={{ marginTop: "10px" }}>
        ...
        <DetailItem
          icon={<IoMdPin style={{ color: "#E4A951" }} />}
          text="95, Institutional Area, Sector 32, Gurugram, Haryana 122002"
        />
      </div>
    </div>
  );
