    ...
    <section className={styles.section1}>
      ...
      <div className={styles.storyContent}>
        ...
        <div className={styles.storyText}>
          ...
          in 2015 as Co-founder of Zapplon, transforming corporate transport solutions with
          innovation and operational excellence. His strengths in sales, marketing, and operations
          laid the foundation for building scalable, value-driven ventures.
          <br />
          <br />
          Complementing this vision, Garvit brings more than 14 years of experience in banking and
          finance, having worked with leading institutions such as HDFC Bank, IndusInd Bank, Yes
          Bank, and Kotak Bank. A Gold Medalist in IT, he has driven growth across corporate banking
          and wealth management verticals.
          <br />
          <br />
