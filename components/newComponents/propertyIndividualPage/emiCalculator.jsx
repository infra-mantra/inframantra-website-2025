...
function EmiCalculator({ price, name }) {
  ...
  const maxYearTotal = schedule.reduce(
    (mx, y) => Math.max(mx, y.principal + y.interest),
    0
  );
  ...
  return (
    <div className={styles.emiWrapper}>
      <h2 className={styles.emiHeading}>
        Home Loan EMI Calculator
      </h2>
      <p className={styles.emiSub}>
        Estimate your monthly instalment. Adjust the loan amount, interest rate
        and tenure to plan your purchase.
      </p>
        ...
        <div className={styles.charts}>
          ...
          <div className={styles.chartCard}>
            <div className={styles.chartHead}>
              ...
              <div className={styles.legend}>
                <span><i className={styles.dotPrincipal} /> Principal</span>
                <span><i className={styles.dotInterest} /> Interest</span>
              </div>
            </div>
            <svg
          ...
          <div className={styles.chartCard}>
            <div className={styles.chartHead}>
              ...
              <div className={styles.legend}>
                <span><i className={styles.dotBalance} /> Loan balance</span>
              </div>
            </div>
            <svg
              className={styles.svg}
            ...
            >
              <line x1={PAD_L} y1={PAD_T + balPlotH} x2={VBW - PAD_R} y2={PAD_T + balPlotH} className={styles.axis} />
      ...
      <p className={styles.disclaimer}>
        *Indicative figures for planning only. Actual EMI, interest rate and
        eligibility are subject to your lender&apos;s terms.
      </p>
    </div>
  );
}
