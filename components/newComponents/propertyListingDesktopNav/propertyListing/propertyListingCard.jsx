        ...
        <div className={styles.propertyListPageSectionFlex}>
          <div className={styles.propertyListPageLeftSection}>
            {fetchedProperties.length > 0 ? (
                ...
                .map((prop) => (
                  ...
                  >
                    ...
                    <div className={styles.propertyListingCardRightSection}>
                      ...
                      <p
                        className={
                          styles.propertyListingCardRightSectionLocation
                        }
                      >
                        <svg
                      ...
                      <div
                        className={
                          styles.propertyListingCardRightSectionGridContainer
                        }
                      >
                        ...
                        <p className={styles.listingDetailRow}>
                          Config:
                          <span className={styles.listingDetailValue}>
                            {prop.configuration}
                          </span>
                        </p>
                        <p className={styles.listingDetailRow}>
                      ...
                      <div className={styles.description}>
                        <p className={styles.clampTwoLines}>
                          {prop.description}
                        </p>
                      </div>
                      <div
              ...
              <h3 className={styles.noPropertiesSection}>
                No Properties Found
              </h3>
            )}{" "}
