...
import { submitChatbotLead } from "../lib/ChatbotLead.jsx";
import {
...
export default function PropertyChatbot() {
  ...
  const pushUser = (text) => appendMsg({ id: nextId(), from: "user", type: "text", text });
    ...
    <>
      ...
      <style jsx>{`
        ...
        .imbot-launcher {
          ...
          box-shadow:
            0 10px 26px rgba(184, 130, 31, 0.5),
        ...
        .imbot-launcher::before {
          ...
          background: radial-gradient(
            circle,
            rgba(214, 157, 46, 0.45) 0%,
            rgba(214, 157, 46, 0) 70%
          );
        ...
        .imbot-launcher:hover {
          ...
          box-shadow:
            0 14px 32px rgba(184, 130, 31, 0.6),
