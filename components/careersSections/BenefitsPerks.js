...
function BenefitsPerks() {  
  const data = [
    ...
    },
    {
      ...
      content:
        "Regular acknowledgment and rewards for hard work and achievements.",
    },
      {
      _id: "bnf4",
      ...
      content:
        "Opportunities for internal promotions and career progression within the company.",
    },
     {
      _id: "bnf4",
  ...
  return (
    <section className={style.perkSection}>
      <h2 className={style.perkHeading}><span className={style.perkYl}>Perks and Benefits </span>{" "}at INFRAMANTRA</h2>
