...
export default function PropertyCard({ property }) {
  ...
  const location = [property.subLocality?.name, property.locality?.name].filter(Boolean).join(", ");
    ...
    <>
      <div className={styles.propertyCard} onClick={handleNavigateIndividualProperty}>
        ...
        <div className={styles.propertyContent}>
          ...
          {location && <p className={styles.propertyLocation}>{location}</p>}
