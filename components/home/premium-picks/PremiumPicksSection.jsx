...
import { PremiumCardsSkeleton } from "../HomeSkeletons.jsx";
    ...
    <div className={styles.premiumPicksContainer}>
      <div className={styles.premiumContentWrapper}>
        ...
        <div className={styles.premiumSectionHeader}>
          <h1 className={styles.premiumMainTitle}>
        ...
        {locationStatus === "detecting" && (
          <div className={styles.premiumLocationStatus}>🌍 Detecting your location...</div>
        )}
        ...
        <div className={styles.localityViewMoreContainer}>
          <button className={styles.localityViewMoreButton} onClick={handleViewMore}>
            View All
          </button>
        </div>
      </div>
