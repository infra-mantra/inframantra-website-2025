...
import CalculatorCards from "../../components/calculators/CalculatorCards.jsx";
    ...
    >
      ...
      <div className={styles.shell}>
        ...
        <section className={styles.seoContent}>
          ...
          <p>
            Buying a home is the biggest financial decision most families make, and small
            differences in interest rate, tenure or down payment can change your total cost by lakhs
            of rupees. Inframantra&apos;s free home loan calculator and property calculator tools
            put that maths in your hands so you can plan your purchase with confidence instead of
            guesswork. Every calculator works instantly in your browser, with no sign-up and no
            cost.
          </p>
          ...
          <ul>
            <li>
              ...
              — already know your loan amount? Our EMI calculator shows your exact monthly
              instalment, total interest payable and a year-by-year payment breakup for any loan
              amount, interest rate and tenure.
            </li>
            <li>
              <Link href="/calculators/loan-eligibility">
                <a>
                  <strong>Loan Eligibility Calculator</strong>
                </a>
              </Link>{" "}
              — not sure how much you can borrow? This home loan eligibility calculator uses your
              monthly salary and existing obligations to show the loan and property budget you
              qualify for.
            </li>
            <li>
              <Link href="/calculators/home-buying-plan">
                <a>
                  <strong>Home Buying Planner</strong>
                </a>
              </Link>{" "}
              — buying in a few years? Use this home affordability calculator to find the monthly
              savings target for your down payment, or check the home your budget can buy today.
            </li>
          </ul>
          <h3>How a home loan EMI calculator helps you plan</h3>
          <p>
            A home loan EMI calculator uses the standard reducing-balance formula to turn your loan
            amount, interest rate and tenure into a single monthly figure, so you can compare
            lenders and tenures before you commit. Pair it with the loan eligibility calculator to
            confirm the amount a bank is likely to sanction on your salary, then use the home
            affordability calculator to map out a realistic down payment and buying timeline.
            Together, these property calculators give you a clear, month-by-month picture of what
            your next home will really cost.
          </p>
          <p>
            Once you know your numbers, browse thousands of RERA-approved apartments, villas and
            plots across Gurgaon, Delhi NCR and beyond — and let an Inframantra advisor help you
            find the right property, with home loan assistance and documentation support along the
            way.
          </p>
        </section>
