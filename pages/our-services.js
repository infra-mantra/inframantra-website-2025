...
function ServicesPage() {
  ...
  return (
    <Wrapper
      ...
      description={
        "INFRAMANTRA is a Real Estate Firm that helps to Build Value on Commercial and Residential properties. We work with the top Builders in Gurgaon, Pune, and Noida. "
      }
          ...
          <div className={styles.servicePageFirstSalePointContainer} id="Site-Visits">
            ...
            <div className={styles.servicePageFirstPointDescriptionWrapper}>
              ...
              <div className={styles.servicePageFirstPointDescriptionContentWrapper}>
                <p>
                  Explore your dream home with our property experts and understand every detail like
                  surroundings, locality, and all the amenities of the project.
                </p>
              </div>
            </div>
          </div>
        ...
        {isDesktop ? (
          <>
            <div className={styles.servicePageFirstSalePointContainer} id="Consultancy">
              <div
                className={`${styles.servicePageFirstPointDescriptionWrapper} ${styles.servicePageFirstPointDescriptionWrapperSecondSectionNew}`}
              >
                <div className={styles.servicePageFirstPointDescriptionHeaderFlex}>
                  <img
                    className={styles.servicePageFirstPointDescriptionHeaderIcon}
                ...
                <div className={styles.servicePageFirstPointDescriptionContentWrapper}>
                  <p>
                    Get valuable insights and personalised advice from our real estate consultants,
                    who will help you out in exploring the best options, and finalise your dream
                    home.
                  </p>
                </div>
              </div>
              <div
                className={`${styles.servicePageFirstPointImgWrapper} ${styles.servicePageFirstPointImgWrapperSecondSectionNew}`}
              >
                <img
                  className={styles.servicePageFirstPointImg}
                ...
                />
                <div
                  className={`${styles.servicePageFirstPointImgBgrd} ${styles.servicePageFirstPointImgBgrdSecondSectionNew}`}
                />
              </div>
            </div>
              ...
              <div className={styles.servicePageSecondSectionIconFlexContainer}>
                <div className="servicePageSecondSectionIconFlex">
                  <img
                    ...
                    alt="Market Analysis And Insights"
                  />
                  <p>Customized Solutions for Buying, Selling, or Leasing Properties</p>
                </div>
                <div></div>
              </div>
            </div>
          ...
          <div className={styles.servicePageFirstSalePointContainer} id="Consultancy">
            ...
            <div className={styles.servicePageFirstPointImgWrapper}>
              ...
              />
              <div
                className={`${styles.servicePageFirstPointImgBgrd} ${styles.servicePageFirstPointImgBgrdRight}`}
              />
            </div>
            <div className={styles.servicePageFirstPointDescriptionContentWrapper}>
              <p>
                Get valuable insights and personalised advice from our real estate consultants, who
                will help you out in exploring the best options, and finalise your dream home.
              </p>
            </div>
            <div className={styles.servicePageSecondPointIconsContainer}>
              <div className={styles.servicePageSecondPointIconsColumnFlexContainer}>
                <div
                  className={`${styles.servicePageSecondPointIconFlex} ${styles.iconContentFlexStart}`}
                >
                  <img
                    src="https://inframantra.blr1.cdn.digitaloceanspaces.com/servicesPage/Market%20analysis%20and%20insights.svg"
                    alt="Market Analysis And Insights"
                ...
                <div
                  className={`${styles.servicePageSecondPointIconFlex} ${styles.iconContentFlexEnd} `}
                >
                  <img
                    src="https://inframantra.blr1.cdn.digitaloceanspaces.com/servicesPage/Assistance%20with%20legal%20and%20regulatory%20requirements.svg"
                    alt="Market Analysis And Insights"
                ...
                >
                  ...
                  >
                    Customized Solutions for Buying, Selling, or Leasing Properties
                  </p>
                </div>
              </div>
            </div>
        ...
        {isDesktop ? (
          <div className={styles.servicePageThirdSalePointContainer} id="Hand-Holding">
            ...
            <p className={styles.servicePageThirdSalePointDescription}>
              From home assistance to key handover, we ensure a seamless and a hassle-free
              experience, letting you settle into your new home with ease.
            </p>
              ...
              <div className={styles.servicePageThirdPointDescriptionWrapper}>
                ...
                <div className={styles.servicePageThirdPointDescriptionContentWrapper}>
                  ...
                  <p className={styles.servicePageThirdPointDescriptionContentHeaderData}>
                    Simplify your paperwork with our expert help, ensuring a smooth, hassle-free
                    transaction at every step, so that you can experience efficiency and ease like
                    never before.
                  </p>
                </div>
              </div>
            ...
            <div className={styles.servicePageFirstSalePointContainer}>
              ...
              <div className={styles.servicePageThirdPointDescriptionWrapper}>
                ...
                <div className={styles.servicePageThirdPointDescriptionContentWrapper}>
                  ...
                  <p className={styles.servicePageThirdPointDescriptionContentHeaderData}>
                    Easily connect with developers through our premium services, timely updates and
                    smooth communication throughout your home-buying journey. We ensure a
            ...
            <div className={styles.servicePageFirstSalePointContainer}>
              ...
              <div className={styles.servicePageThirdPointDescriptionWrapper}>
                ...
                <div className={styles.servicePageThirdPointDescriptionContentWrapper}>
                  ...
                  <p className={styles.servicePageThirdPointDescriptionContentHeaderData}>
                    We offer various home loan solutions from top loan providers that are tailored
                    to your needs, so that you can secure the best offers and terms for your home
                    loan.
                  </p>
                </div>
              </div>
            ...
            <div className={styles.servicePageFirstSalePointContainer}>
              ...
              <div className={styles.servicePageThirdPointDescriptionWrapper}>
                ...
                <div className={styles.servicePageThirdPointDescriptionContentWrapper}>
                  ...
                  <p className={styles.servicePageThirdPointDescriptionContentHeaderData}>
                    Experience a smooth key handover, where each and every detail is managed to
                    ensure a smooth and effortless move-in to your dream home.
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className={styles.servicePageThirdPointDescriptionWrapper}>
              ...
              <div className={styles.servicePageThirdPointDescriptionContentWrapper}>
                ...
                <p className={styles.servicePageThirdPointDescriptionContentHeaderData}>
                  Easily connect with developers through our premium services, timely updates and
                  smooth communication throughout your home-buying journey. We ensure a streamlined
            ...
            <div className={styles.servicePageThirdPointDescriptionWrapper}>
              ...
              <div className={styles.servicePageThirdPointDescriptionContentWrapper}>
                ...
                <p className={styles.servicePageThirdPointDescriptionContentHeaderData}>
                  We offer various home loan solutions from top loan providers that are tailored to
                  your needs, so that you can secure the best offers and terms for your home loan.
                </p>
              </div>
            </div>
            <div className={`${styles.servicePageFirstPointImgWrapper} ${styles.noBottomMargin}`}>
            ...
            <div className={styles.servicePageThirdPointDescriptionWrapper}>
              ...
              <div className={styles.servicePageThirdPointDescriptionContentWrapper}>
                ...
                <p className={styles.servicePageThirdPointDescriptionContentHeaderData}>
                  Experience a smooth key handover, where each and every detail is managed to ensure
                  a smooth and effortless move-in to your dream home.
                </p>
              </div>
            </div>
          </div>
        ...
        {isDesktop ? (
          <div className={styles.servicePageResaleContainer} id="Resale-Services">
            <div className={styles.servicePageResaleDescriptionWrapper}>
              ...
              <p>
                Unlock your property`s value with InfraMantra`s premium resale services offering
                top-notch marketing, seamless negotiations, and full legal support. Sell faster and
                smarter with us!
              </p>
              <button
                btnText="Contact Now"
