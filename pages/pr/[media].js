      ...
      <div className={styles["media-container-individual"]}>
        ...
        <div className={styles["media-page"]}>
          ...
          <div className={styles["media-content"]}>
            ...
            ></div>
            <div>{isDesktop && <Share content={allData?.detail?.title || ""} />}</div>
          </div>
                  ...
                  <a className={styles["media-sidebar-item"]}>
                    {post.image && (
                      <img
                        src={post.image}
                        alt={post.title}
                        className={styles["media-sidebar-img"]}
                      />
                    )}
          ...
          <div className={styles["media-grid"]}>
            ...
            <div className={styles["media-container"]}>
              {allData.related.map((post) => (
                ...
                >
                  {post.image && (
                    <img src={post.image} alt={post.name} className={styles["blogs-media-img"]} />
                  )}
                  <div>
...
// regenerated on demand anyway — prerendering all ~7 of them (plus the slug-list
